...
# File: population.py
# Description: Represent a population / generation. Allows for reproduction, and preservation.
...
class Population:
    #Set whether or not the top half is preserved and the mutation rate for the population.
    ...
    # Set up randomized first population
